...
export type MutationFieldPolicy = {
	...
	updateDeliverySchedule?: FieldPolicy<any> | FieldReadFunction<any>
};
...
export type UpdateDeliveryScheduleKeySpecifier = ('errors' | 'deliveryScheduler' | UpdateDeliveryScheduleKeySpecifier)[];
