...
export type SubscriptionFrequency =
  /** daily */
  | 'FREQUENCYTYPES_DAILY'
  /** weekly */
  | 'FREQUENCYTYPES_WEEKLY'
  /** monthly */
  | 'FREQUENCYTYPES_MONTHLY'
  /** quarterly */
  | 'FREQUENCYTYPES_QUARTERLY'
  /** yearly */
  | 'FREQUENCYTYPES_YEARLY';
...
export type SubscriptionType = Node & ObjectWithMetadataV2 & {
  /** List of public metadata items. Can be accessed without permissions. */
  metadata: Array<Maybe<MetadataItemV2>>;
  /** List of private metadata items.Requires proper staff permissions to access. */
  privateMetadata: Array<Maybe<MetadataItemV2>>;
  ...
  nextOrderDate: Maybe<Scalars['Date']>;
  previousOrderDate: Maybe<Scalars['Date']>;
  startDate: Scalars['DateTime'];
  endDate: Maybe<Scalars['DateTime']>;
  created: Scalars['DateTime'];
  updated: Scalars['DateTime'];
  successOrders: Maybe<Scalars['Int']>;
  failedOrders: Maybe<Scalars['Int']>;
  /** checkout related to subscription */
  subscriptionCheckouts: Maybe<Array<Maybe<Checkout>>>;
  /** order related to subscription */
  subscriptionOrders: Maybe<Array<Maybe<Order>>>;
};
