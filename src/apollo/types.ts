...
export type CheckoutCustomerAttachNewMutation = {
  checkoutCustomerAttach: Maybe<{
    checkout: Maybe<
      {
        paymentMethod: Maybe<
          Pick<
...
export const CheckoutCustomerAttachNewDocument = gql`
  ...
  ${CheckoutFragmentDoc}
`;
export type CheckoutCustomerAttachNewMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useCheckoutCustomerAttachNewMutation(
  baseOptions?: Apollo.MutationHookOptions<
    CheckoutCustomerAttachNewMutation,
    CheckoutCustomerAttachNewMutationVariables
  >
  ...
  return Apollo.useMutation<
    CheckoutCustomerAttachNewMutation,
    CheckoutCustomerAttachNewMutationVariables
  >(CheckoutCustomerAttachNewDocument, options);
}
export type CheckoutCustomerAttachNewMutationHookResult = ReturnType<
  typeof useCheckoutCustomerAttachNewMutation
>;
export type CheckoutCustomerAttachNewMutationResult = Apollo.MutationResult<
  CheckoutCustomerAttachNewMutation
>;
export type CheckoutCustomerAttachNewMutationOptions = Apollo.BaseMutationOptions<
  CheckoutCustomerAttachNewMutation,
  CheckoutCustomerAttachNewMutationVariables
>;
