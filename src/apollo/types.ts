...
export type ProductFieldsFragment = (
  Pick<Product, 'id' | 'name' | 'slug' | 'isAvailable' | 'isAvailableForPurchase'>
  & { metadata: Array<Maybe<Pick<MetadataItem, 'key' | 'value'>>>, productType: Pick<ProductType, 'id' | 'name' | 'isShippingRequired'>, thumbnail: Maybe<Pick<Image, 'url' | 'alt'>>, images: Maybe<Array<Maybe<Pick<ProductImage, 'id' | 'url' | 'alt'>>>>, variants: Maybe<Array<Maybe<(
    ...
    & { metadata: Array<Maybe<Pick<MetadataItem, 'key' | 'value'>>>, attributes: Array<{ attribute: (
        Pick<Attribute, 'id' | 'name' | 'slug'>
        & { metadata: Array<Maybe<Pick<MetadataItem, 'key' | 'value'>>> }
      ), values: Array<Maybe<(
        Pick<AttributeValue, 'id' | 'name'>
        & { value: AttributeValue['name'] }
      )>> }>, images: Maybe<Array<Maybe<Pick<ProductImage, 'id' | 'url' | 'alt' | 'sortOrder'>>>>, pricing: Maybe<(
      Pick<VariantPricingInfo, 'onSale'>
      & { priceUndiscounted: Maybe<{ gross: Pick<Money, 'amount' | 'currency'>, net: Pick<Money, 'amount' | 'currency'> }>, price: Maybe<{ gross: Pick<Money, 'amount' | 'currency'>, net: Pick<Money, 'amount' | 'currency'> }> }
    )> }
