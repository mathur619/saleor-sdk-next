...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_metadata {
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_product_metadata {
  __typename: "MetadataItem";
  /**
   * Key of a metadata item.
   */
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_product {
   ...
   */
  metadata: (UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_product_metadata | null)[];
}
...
export interface UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant {
   ...
   */
  images:
    | (UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_images | null)[]
    | null;
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
  metadata: (UpdateCheckoutLine_checkoutLinesUpdate_checkout_lines_variant_metadata | null)[];
  /**
...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product_weight {
  __typename: "Weight";
  /**
   * Weight unit.
   */
...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product {
   ...
   */
  isAvailableForPurchase: boolean | null;
  weight: CreateCheckout_checkoutCreate_checkout_lines_variant_product_weight | null;
...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant {
   ...
   */
  images:
    | (CreateCheckout_checkoutCreate_checkout_lines_variant_images | null)[]
    | null;
  /**
   * List of public metadata items. Can be accessed without permissions.
   */
