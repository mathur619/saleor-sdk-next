...
export const SALEOR_CSRF_TOKEN = "csrf_token";
export const SALEOR_AUTH_TOKEN = "token";
export const SALEOR_REFRESH_TOKEN = "refresh_token";
...
export const SALEOR_WISHLIST = "data_wishlist";
